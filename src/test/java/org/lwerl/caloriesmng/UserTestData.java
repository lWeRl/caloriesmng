...
public class UserTestData {
    public static final User USER = new User(100000,"User","user@test.ru","user", Role.ROLE_USER);
    public static final User ADMIN = new User(100001,"Admin","admin@test.ru","admin", Role.ROLE_ADMIN);
